...
data class Settings(
    ...
    enum class TunerPitchDetectionAlgorithm(
        ...
        YIN(R.string.settings_detection_algorithm_yin),
        FFT_YIN(R.string.settings_detection_algorithm_fft_yin),
        MPM(R.string.settings_detection_algorithm_mpm),
        AMDF(R.string.settings_detection_algorithm_amdf),
        DYWA(R.string.settings_detection_algorithm_dywa);
    ...
    enum class StringLayout(
        ...
        LIST(R.string.settings_tuner_layout_list),
        GRID(R.string.settings_tuner_layout_grid),
    }
    ...
    companion object {
        const val MIN_BASE_FREQUENCY = 420
        const val MAX_BASE_FREQUENCY = 460
        const val MIN_DEVIATION = 3
        const val MAX_DEVIATION = 90

        fun clampBaseFrequency(value: Int): Int =
            value.coerceIn(MIN_BASE_FREQUENCY, MAX_BASE_FREQUENCY)

        fun clampDeviation(value: Int): Int =
            value.coerceIn(MIN_DEVIATION, MAX_DEVIATION)
